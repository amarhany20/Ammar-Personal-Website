var cvLink = "./Resources/Resume/Ammar Hany CV.pdf";
...
var toros_english_transcript_link =
  "../Resources/Transcripts/2024-04-03 English Google Translated Transcript.pdf";
var toros_turkish_transcript_link =
  "../Resources/Transcripts/2024-04-03 Turkish Transcript.pdf.pdf";
...
document
  .querySelectorAll(".toros-english-transcript-link")
  .forEach(function (link) {
    link.href = toros_english_transcript_link;
  });

document
  .querySelectorAll(".toros-turkish-transcript-link")
  .forEach(function (link) {
...
document.querySelectorAll(".cv-projects-link").forEach(function (link) {
  link.href = "." + cvLink;
});

document.querySelectorAll(".portfolio-projects-link").forEach(function (link) {
  link.href = "." + portfolioLink;
});
